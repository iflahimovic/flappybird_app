...
class _HomePageState extends State<HomePage> {
  ...
  int score = 0;
  int highscore =
      0; //theoretisch nh Datenbank dran hängen, um auch nach Spiel Beendigung wieder Highscore anzeigen zu können
  bool barrierOneCounted = false;
  bool barrierTwoCounted = false;

  bool detectCollision(int birdY, int upperBarrierY, int lowerBarrierY) {
    if (birdY > upperBarrierY && birdY < lowerBarrierY) {
      return false;
    }
    return true;
  }
  ...
  void startGame() {
    ...
    Timer.periodic(Duration(milliseconds: 50), (timer) {
      ...
      if (barrierXone < -2) {
        ...
        barrierOneCounted =
            false; //Barriere wurde versetzt und darf wieder gezählt werden
